...
class World {
    constructor({
        ...
        this.scene.background = new THREE.Color(0x06283D);
    ...
    loadMusic() {
        return new Promise((resolve) => {
            ...
            audioLoader.load(
                "https://res.cloudinary.com/dddvljza3/video/upload/v1668099239/ytmp3free.cc_hoang-hon-cheung-bao-khanh-ben-cover-youtubemp3free.org_ohk828.mp3",
                (buffer) => {
